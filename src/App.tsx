...
const ProductGrid = lazyWithRetry(() => import('./components/ProductGrid'));
const ProductDetail = lazyWithRetry(() => import('./components/ProductDetail'));
const ProductSearch = lazyWithRetry(() => import('./components/ProductSearch'));
...
const ReturnsRefunds = lazyWithRetry(() => import('./components/ReturnsRefunds'));
...
const FeaturedReviews = lazyWithRetry(() => import('./components/FeaturedReviews'));
const Cart = lazyWithRetry(() => import('./components/Cart/Cart'));
const AdminDashboard = lazyWithRetry(() => import('./components/Admin/AdminDashboard'));
const BlogListView = lazyWithRetry(() => import('./pages/blog/BlogListView'));
const BlogPostView = lazyWithRetry(() => import('./pages/blog/BlogPostView'));
const WoodenToysNZ = lazyWithRetry(() => import('./pages/WoodenToysNZ'));
const ReviewForm = lazyWithRetry(() => import('./components/ReviewForm'));
const ReviewsAdmin = lazyWithRetry(() => import('./components/ReviewsAdmin'));

...
const WhyKauriWoodMakesSuperiorToysContent: React.FC = () => (
  <p>Content for Kauri wood toys coming soon...</p>
);
...
const BestFirstBirthdayWoodenToysContent: React.FC = () => (
  <>
    ...
    <p className="mb-6">
      Poppa's Wooden Creations is nestled in the heart of Whangarei, New Zealand, a place known for its beautiful native timbers like Kauri, Rimu, and Macrocarpa. Our toys are carefully handcrafted by skilled artisans, ensuring that each piece is unique and of the highest quality.
    </p>
    ...
    <p className="mb-6">
      Consider our popular <strong>Kauri Rocking Horse</strong>. Made from native Kauri timber, this rocking horse is sturdy, beautifully crafted, and designed to be a family heirloom.
    </p>
  </>
);
